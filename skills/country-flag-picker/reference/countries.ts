...
// Full ISO 3166-1 alpha-2 set (250 entries incl. XK Kosovo, which is user-assigned, not ISO).
...
export const countries: Country[] = [
  ...
  { code: "AQ", name: "Antarctica", dialCode: "" },
  ...
  { code: "BV", name: "Bouvet Island", dialCode: "" },
  ...
  { code: "TF", name: "French Southern Territories", dialCode: "" },
  ...
  { code: "HM", name: "Heard and McDonald Islands", dialCode: "" },
  ...
  { code: "PN", name: "Pitcairn Islands", dialCode: "" },
  ...
  { code: "GS", name: "South Georgia and South Sandwich Islands", dialCode: "" },
  ...
  { code: "UM", name: "U.S. Outlying Islands", dialCode: "" },
